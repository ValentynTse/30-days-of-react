...
class DifferentInputsForm extends Component {
   // declaring state
   state = {
      firstName: '',
      lastName: '',
   ...
   validate = () => {
      ...
      // Validation for tel (telephone number)
      if (
            ...
            <form onSubmit={this.handleSubmit} noValidate>
               <div className='row'>
                  ...
                  <div className='form-group'>
                     ...
                     />
                     <br />
                     <small>{this.validate().lastName}</small>
                  </div>
                  <div className='form-group'>
                     ...
                     />
                     <br />
                     <small>{this.validate().email}</small>
                  </div>
               </div>
               <div className='form-group'>
               ...
               <div>
                  ...
                  <select name='country' onChange={this.handleChange} id='country' value={this.state.country}>
                     {selectOptions}
                  </select>
               </div>
               <div>
...
export default DifferentInputsForm;